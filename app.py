...
lesson_data = {
    ...
    4: {"topic": "Қанықпаған байланыс",
        ...
        questions = [
    ("Алкендерге бром суын ($Br_2$) қосқанда не байқалады?", ["Ерітінді түссізденеді", "Күлгін түске боялады", "Қоңыр тұнба түзіледі"], 0),
    
    ("Вагнер реакциясы ($KMnO_4$) нәтижесінде ерітінді түсі қалай өзгереді?", ["Күлгін түс жойылып, қоңыр тұнба түседі", "Түсі өзгермейді", "Көк түске өзгереді"], 0),
    
    ("Көмірсутектердің қанықпағандық қасиетін қалай анықтаймыз?", ["Түсті реакциялар (сапалық) арқылы", "Жағу арқылы", "Тығыздығын өлшеу арқылы"], 0),
    
    ("Қос байланысы ($C=C$) бар көмірсутектер қай топқа жатады?", ["Алкандар", "Алкендер", "Алкиндер"], 1),
    
    ("Заттың құрамында белгілі бір функционалдық топтың бар-жоғын анықтайтын әдіс?", ["Сапалық талдау", "Сандық талдау", "Термодинамикалық талдау"], 0),
    
    ("Алкендердің бромдалу реакциясы қандай жағдайда жүреді?", ["Қалыпты жағдайда өте жылдам", "Тек Күн сәулесі түскенде", "Жоғары қысым мен температурада"], 0),
    
    ("Алкендерге тән байланыс түрін көрсетіңіз:", ["$\pi$ және $\sigma$ байланысы (қос байланыс)", "Тек дара $\sigma$ байланыс", "Үштік байланыс"], 0),
    
    ("Этиленді ($CH_2=CH_2$) этаннан ($CH_3-CH_3$) қалай ажыратуға болады?", ["Бром суымен әрекеттестіру арқылы", "Суда еріту арқылы", "Иісіне қарап"], 0)
]
