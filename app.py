...
# Автоматикалық 5–34 сабақ генерациясы үлгісі:
for i in range(5, 35):
    lesson_data[i] = {
        "topic": f"{i}-сабақ. Тақырып",
        "theory": f"{i}-сабақ теориясы: маңызды түсініктер мен формулалар.",
        "lab": ("Br₂, Cu(OH)₂, KMnO₄, NaHCO₃", "Бақылау сипаттамасы", "Қорытынды"),
        "ai": f"{i}-сабақ AI тапсырмасы: функционалдық топты анықта",
        "test": [
            (f"{i}-сабақ сұрақ {j+1}?", ["Жауап 1", "Жауап 2", "Жауап 3"], j % 3)
            for j in range(10)
        ]
    }
