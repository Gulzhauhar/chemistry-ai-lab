...
lesson_data = {
    ...
    # ---------------- 5–34 сабақтарды нақты реактивтермен толықтыру ----------------
    5: {"topic": "Альдегидтер мен кетондар",
        "theory": "Альдегидтер –CHO, кетондар –C=O функционалдық топқа ие.",
        "lab": ("Fehling ерітіндісі", "Қызыл түсті тұнба түзіледі", "Альдегид бар екенін көрсетеді"),
        ...
        "test": [
            ...
            ("Кетонның белгісі?", ["Түссіз", "Қызыл тұнба жоқ", "Көк түске боялу"], 1),
            ...
            ("Кетонның мысалы?", ["CH₃COCH₃", "CH₃CHO", "C₂H₅OH"], 0),
            ("Қолданылған реактив?", ["Fehling", "Br₂", "CuSO₄"], 0),
            ("Тұнба түзілуі не білдіреді?", ["Альдегид бар", "Кетон бар", "Спирт бар"], 0),
            ("Сапалық әдіс не үшін?", ["Функционалдық топты анықтау", "Бағалау", "Талдау"], 0)
        ]
    },
    6: {"topic": "Карбон қышқылдары",
        "theory": "Карбон қышқылдары –COOH топқа ие. NaHCO₃-пен әрекеттескенде газ бөлінеді.",
        "lab": ("NaHCO₃", "Көпіршіктер бөлінеді", "Карбон қышқылы барын көрсетеді"),
        "ai": "Берілген қосылыс карбон қышқылы ба?",
        "test": [
            ("–COOH қай топқа жатады?", ["Қышқыл", "Спирт", "Амин"], 0),
            ("NaHCO₃ қосқанда не болады?", ["Көпіршік бөліну", "Түс өзгеру", "Қызыл тұнба"], 0),
            ("Қышқылдың белгісі?", ["Көпіршік", "Көк түске боялу", "Түссіздену"], 0),
            ("Сапалық реакция мақсаты?", ["Топты анықтау", "Бағалау", "Иіс"], 0),
            ("Карбон қышқылы мысалы?", ["CH₃COOH", "CH₃CH₂OH", "CH₃CHO"], 0),
            ("Қолданылған реактив?", ["NaHCO₃", "Cu(OH)₂", "Br₂"], 0),
            ("Көпіршік түзілуі не білдіреді?", ["Қышқыл бар", "Спирт бар", "Амин бар"], 0),
            ("Реакция жылдамдығы?", ["Жылдам", "Баяу", "Тек қыздырғанда"], 0),
            ("Қышқылдардың реакциясы қандай?", ["Сілтімен", "Қышқылмен", "Суда"], 0),
            ("Сапалық әдіс не үшін?", ["Функционалдық топты анықтау", "Бағалау", "Талдау"], 0)
        ]
    },
    # 7–34 сабақтарды осылай толықтырыңыз, әр сабаққа нақты реактив, бақылау, қорытынды, AI тапсырма және 10 тест сұрақ
}
